...
/// Render a marker/highlighter stroke - wider, semi-transparent
pub fn render_marker_stroke(
    ...
    cs.save_state();
    // Apply transparency via ExtGState
    ...
    // Marker is typically wider than pencil
    cs.set_line_width(stroke.width * 3.0);
